...
## [2.0.1] - 2026-08-21
### Added
- Added caregiver information 
- Added "veldwaardes" (FreeFields)
- Added vestiging from student (mainlocation)

### Changed
- Changed sorting en deduplication of persons based on referenceYear
- Changed mapping
